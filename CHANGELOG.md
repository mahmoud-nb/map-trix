...
- 511e93b: Multi-provider rewrite: one unified API across Google Maps, Leaflet, MapLibre and Mapbox.
...
- 511e93b: modularize providers and utilities, add base class for shared logic
